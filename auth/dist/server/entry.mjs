...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/access-denied.astro",
...
var _page0 = () => import("./chunks/node_CwhPO6XJ.mjs").then((n) => n.t);
var _page1 = () => import("./chunks/access-denied_De0MIqMr.mjs");
var _page2 = () => import("./chunks/cookie_CUjTpOHE.mjs");
var _page3 = () => import("./chunks/login_B1s7MgAa.mjs");
var _page4 = () => import("./chunks/logout_S0QeZMVZ.mjs");
var _page5 = () => import("./chunks/verify_BySPWemv.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["../node_modules/astro/dist/assets/endpoint/node.js", _page0],
	["src/pages/access-denied.astro", _page1],
	["src/pages/cookie.ts", _page2],
	["src/pages/login.astro", _page3],
	["src/pages/logout.ts", _page4],
	["src/pages/verify.ts", _page5]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///home/runner/work/pocketbase-auth/pocketbase-auth/docker/","cacheDir":"file:///home/runner/work/pocketbase-auth/pocketbase-auth/docker/node_modules/.astro/","outDir":"file:///home/runner/work/pocketbase-auth/pocketbase-auth/docker/dist/","srcDir":"file:///home/runner/work/pocketbase-auth/pocketbase-auth/docker/src/","publicDir":"file:///home/runner/work/pocketbase-auth/pocketbase-auth/docker/public/","buildClientDir":"file:///home/runner/work/pocketbase-auth/pocketbase-auth/docker/dist/client/","buildServerDir":"file:///home/runner/work/pocketbase-auth/pocketbase-auth/docker/dist/server/","adapterName":"@astrojs/node","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"../node_modules/astro/dist/assets/endpoint/node.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CakW0AV5.css"}],"routeData":{"route":"/access-denied","isIndex":false,"type":"page","pattern":"^\\/access-denied\\/?$","segments":[[{"content":"access-denied","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/access-denied.astro","pathname":"/access-denied","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/cookie","isIndex":false,"type":"endpoint","pattern":"^\\/cookie\\/?$","segments":[[{"content":"cookie","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/cookie.ts","pathname":"/cookie","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.CakW0AV5.css"}],"routeData":{"route":"/login","isIndex":false,"type":"page","pattern":"^\\/login\\/?$","segments":[[{"content":"login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/login.astro","pathname":"/login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/logout","isIndex":false,"type":"endpoint","pattern":"^\\/logout\\/?$","segments":[[{"content":"logout","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/logout.ts","pathname":"/logout","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/verify","isIndex":false,"type":"endpoint","pattern":"^\\/verify\\/?$","segments":[[{"content":"verify","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/verify.ts","pathname":"/verify","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/auth","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/home/runner/work/pocketbase-auth/pocketbase-auth/docker/src/pages/access-denied.astro",{"propagation":"none","containsHead":true}],["/home/runner/work/pocketbase-auth/pocketbase-auth/docker/src/pages/login.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_DS5V7T-N.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/node/server.js":"entry.mjs","\u0000virtual:astro:page:src/pages/access-denied@_@astro":"chunks/access-denied_De0MIqMr.mjs","\u0000virtual:astro:page:src/pages/cookie@_@ts":"chunks/cookie_CUjTpOHE.mjs","\u0000virtual:astro:page:src/pages/login@_@astro":"chunks/login_B1s7MgAa.mjs","\u0000virtual:astro:page:src/pages/logout@_@ts":"chunks/logout_S0QeZMVZ.mjs","\u0000virtual:astro:page:../node_modules/astro/dist/assets/endpoint/node@_@js":"chunks/node_CwhPO6XJ.mjs","/home/runner/work/pocketbase-auth/pocketbase-auth/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_Bii8jWx6.mjs","\u0000virtual:astro:page:src/pages/verify@_@ts":"chunks/verify_BySPWemv.mjs","/home/runner/work/pocketbase-auth/pocketbase-auth/docker/src/components/OAuthLoginButton.astro?astro&type=script&index=0&lang.ts":"_astro/OAuthLoginButton.astro_astro_type_script_index_0_lang.DQNnGNk2.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[],"assets":["/auth/_astro/OAuthLoginButton.astro_astro_type_script_index_0_lang.DQNnGNk2.js","/auth/_astro/Layout.CakW0AV5.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"QNZXwwny7j1fk7Q8OsY+BnlChBWqz/YRRK1aP298o08=","sessionConfig":{"driver":"unstorage/drivers/fs-lite","options":{"base":"/home/runner/work/pocketbase-auth/pocketbase-auth/docker/node_modules/.astro/sessions"}},"image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var mode = "standalone";
var client = "file:///home/runner/work/pocketbase-auth/pocketbase-auth/docker/dist/client/";
var server = "file:///home/runner/work/pocketbase-auth/pocketbase-auth/docker/dist/server/";
var port = 4321;
